...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v7/widget/ak;->u(Landroid/support/v7/widget/ay$w;)V
.end annotation
...
.method constructor <init>(Landroid/support/v7/widget/ak;Landroid/support/v7/widget/ay$w;Landroid/support/v4/h/as;)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ak$4;->a:Landroid/support/v7/widget/ay$w;

    iput-object p3, p0, Landroid/support/v7/widget/ak$4;->b:Landroid/support/v4/h/as;
...
.method public a(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ak$4;->a:Landroid/support/v7/widget/ay$w;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ak;->l(Landroid/support/v7/widget/ay$w;)V
...
.method public b(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ak$4;->b:Landroid/support/v4/h/as;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ak;->i(Landroid/support/v7/widget/ay$w;)V

    iget-object v0, p0, Landroid/support/v7/widget/ak$4;->c:Landroid/support/v7/widget/ak;

    iget-object v0, v0, Landroid/support/v7/widget/ak;->f:Ljava/util/ArrayList;
