...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/as;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method a(Landroid/content/Context;Z)Landroid/support/v7/widget/am;
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/av$a;-><init>(Landroid/content/Context;Z)V

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/av$a;->setHoverListener(Landroid/support/v7/widget/au;)V
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/au;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public a(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/av;->g:Landroid/widget/PopupWindow;
...
.method public b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/au;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public b(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/av;->g:Landroid/widget/PopupWindow;
