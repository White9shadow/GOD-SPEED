...
.field private final j:Landroid/support/v7/widget/ar;
...
.field private n:Landroid/support/v7/widget/as;
...
.method a(I)V
    ...
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/as;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/as;->g(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/as;->a()V
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/as;->e()Landroid/widget/ListView;
...
.method getListPopupWindow()Landroid/support/v7/widget/as;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/as;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/as;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/as;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/as;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/as;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->i:Landroid/support/v7/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/as;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->j:Landroid/support/v7/widget/ar;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/ar;->layout(IIII)V
