...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bl;
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/bl;->d:Z

    iput-object v1, v0, Landroid/support/v7/widget/bl;->a:Landroid/content/res/ColorStateList;
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/bl;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/bl;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/bl;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/bl;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/bl;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v6, p1, v3, p2, v2}, Landroid/support/v7/widget/bn;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bn;
    ...
    invoke-virtual {v3, v7}, Landroid/support/v7/widget/bn;->g(I)Z
    ...
    invoke-virtual {v3, v7, v2}, Landroid/support/v7/widget/bn;->g(II)I

    move-result v7

    invoke-static {v6, v0, v7}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bl;

    move-result-object v7

    iput-object v7, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/bl;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/bl;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/bl;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/bl;
    ...
    invoke-static {v6, v4, v0}, Landroid/support/v7/widget/bn;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/bn;
    ...
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/bn;->g(I)Z
    ...
    invoke-virtual {v8, v0, v2}, Landroid/support/v7/widget/bn;->a(IZ)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/bn;->g(I)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/bn;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v9}, Landroid/support/v7/widget/bn;->g(I)Z
    ...
    invoke-virtual {v8, v5}, Landroid/support/v7/widget/bn;->e(I)Landroid/content/res/ColorStateList;

    move-result-object v5

    :cond_4
    :goto_2
    invoke-virtual {v8}, Landroid/support/v7/widget/bn;->a()V

    :goto_3
    sget-object v8, Landroid/support/v7/a/a$j;->TextAppearance:[I

    invoke-static {v6, p1, v8, p2, v2}, Landroid/support/v7/widget/bn;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bn;
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/bn;->g(I)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/bn;->e(I)Landroid/content/res/ColorStateList;
